...
urls={"/trustList/DSC/":["https://de.dscg.ubirch.com/trustList/DSC",None],
      ...
      "/valuesets":["https://distribution.dcc-rules.de/valuesets",None], #has suburl /valuesets/<string:valuesethash>
      "/rules":["https://distribution.dcc-rules.de/rules",None], # has suburl '/rules/<string:rules_country>/<string:rules_sub_hash>'
      "/countrylist":["https://distribution.dcc-rules.de/countrylist",None], 
      "/domesticrules":["https://distribution.dcc-rules.de/domesticrules",None],
...
suburls=["/bnrules","/valuesets","/rules"]
